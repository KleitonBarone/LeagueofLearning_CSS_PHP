...
$insere = ("INSERT INTO usuarios (nome, login, senha) VALUES ('$nome', '$usuario', '$senha')");
        ...
        <nav class="indigo darken-2" role="navigation">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="Login.html" class="white-text text-lighten-1">Login</a></li>
                    <li class="active"><a href="#" class="white-text text-lighten-1">Cadastrar-se</a></li>
                </ul>
                ...
                <ul id="nav-mobile" class="side-nav">
                    ...
                    <li><a href="Login.html" class="blue-text text-darken-4">Login</a></li>
                    <li class="active"><a href="#" class="blue-text text-darken-4">Cadastrar-se</a></li>
                </ul>
     ...
     <div class="section">
         <div class="container">
            <div class="row card-panel gray lighten-1 z-depth-5">
              ...
              <h1 class="title center">Cadastrado com Sucesso!</h1>
              <br />
              <div class="row center">
                  <a class="btn waves-effect waves-light" href="login.html">Voltar</a>
              </div>
