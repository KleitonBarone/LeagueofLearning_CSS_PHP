...
<html lang="pt">
    <head>
        ...
        <title>League of Learning - Erro</title>
        <!-- CSS  -->
     ...
     <div class="section">
         <div class="container">
            <div class="row card-panel gray lighten-1 z-depth-5">
              <h1 class="title center">Usuario e Senha Incorretos</h1>
              <br />
              <div class="row center">
                      <a class="btn-large waves-effect center" href="login.html">Voltar</a>
              </div>
   ...
   <html lang="pt">
    ...
    <body class="indigo">
     ...
     <div class="section">
         <div class="container">
            <div class="row card-panel gray lighten-1 z-depth-5">
              <h1 class="title center">Senha Incorreta</h1>
              <br />
              <div class="row center">
                      <a class="btn-large waves-effect center" href="login.html">Voltar</a>
              </div>
     ...
     <div class="section">
         <div class="container">
            <div class="row card-panel gray lighten-1 z-depth-5">
              ...
              <h1 class="title center">Sucesso no Login</h1>
              <br />
              <div class="row">
                  <div class="input-field center">
                      <input type="text" value="<?=$usuario?>" hidden name="usuario"/>
                      <button class="btn waves-effect waves-light col s6" type="submit" value="Comentarios" name="btnEnviar">Comentarios</button>
                      <a class="btn waves-effect col s6" href="login.html">Sair</a>
                  </div>
              </div>
                </form>
            </div>
